...
install_3proxy() {
    ...
    wget -qO- $URL | tar xf 0.9.4.tar.gz
    cd 3proxy-0.9.4
...
gen_3proxy >/usr/local/etc/3proxy-0.9.4/cfd/3proxy.cfg
...
ulimit -n 65535
/usr/local/etc/3proxy/bin/3proxy /usr/local/etc/3proxy-0.9.4/cfd/3proxy.cfg &
EOF
